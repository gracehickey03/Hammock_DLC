...
# For p14 sensory oxtrko isolation: highlighting the bottom of the cup. 
...
pose_dir = dlc_dir.joinpath("Results", "p14_oxtrko", "pose_estimation")
...
# check the names = line works with file paths in HPG. and there is likely a better way to do it than this. 
...
for i, ind in enumerate(names):
    ...
    if file_path.is_file():
        ...
        x1, y1, x2, y2, pix_per_cm_x, pix_per_cm_y = select_roi(videos[i], "Draw rectangle to outline base of cup.")
